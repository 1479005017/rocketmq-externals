...
func main() {
	var (
		nameServerAddress = "" //address split by ;  (for example 192.168.1.1:9876;192.168.1.2:9876)
		accessKeyId       = ""
		accessKeySecret   = ""
		onsChannel        = "ALIYUN"
		onsAddr           = ""
	...
	nameServerAddress = aliyun.FetchNamesrvAddress(onsAddr)
	rpcHook := &aliyun.AliyunRPCHook{
	...
	rocketMQClientInstance.RegisterProducerWithRPCHook(producer, rpcHook)
